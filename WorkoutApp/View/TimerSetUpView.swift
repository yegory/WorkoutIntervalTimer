...
struct TimerSetUpView: View {
    ...
    @State private var tempNumberOfSets: String = "1"  // For number pad input
    ...
    var body: some View {
        NavigationView {
            VStack(spacing: 30) {
                ...
                HStack {
                    ...
                    Button(action: {
                        ...
                        Text("Sets: \(numberOfSets)")
                            .font(.title2)
                            .frame(width: 150, alignment: .center) // Fixed width for the label
                            .foregroundColor(.white)
                            .padding(.vertical)
                            .background(
                                RoundedRectangle(cornerRadius: 15)
                ...
                .overlay(
                    RoundedRectangle(cornerRadius: 15)
                        .stroke(Color.purple, lineWidth: 3) // Purple outline
                        .blur(radius: 4)
                )
                ...
                HStack(spacing: 10) {
                    ...
                    .background((selectedHour == 0 && selectedMinute == 0 && selectedSecond == 0) ? Color.red.opacity(0.5) : Color.blue) // Change background color when disabled
                    .cornerRadius(15)
                    
                    // Toggle for Alert Sound
